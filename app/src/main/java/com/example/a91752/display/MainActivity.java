...
public class MainActivity extends AppCompatActivity {
    ...
    private String nginxip = "192.168.31.47";
        ...
        if (id == R.id.action_settings) {
            ...
            inputDialog.setPositiveButton("confirm", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Toast.makeText(getApplicationContext(), "you set the interval is " + interval,
                            Toast.LENGTH_LONG).show();
                    task.cancel();
                    timer.cancel();
                    timer = new Timer();
    ...
    class getImgTask extends TimerTask{
        ...
        public void run() {
            ...
            //getMapURL = "http://192.168.31.90:8080/image/willow-full.pgm";
            final Map<String, Object> urlImage = getPgmImage(getMapURL);
            Bitmap b = (Bitmap) urlImage.get("img");
            if(b != null) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
//                    int responseCode = (int) urlImage.get("responseCode");
//                    responseCodeT.setText(responseCode);
    ...
    class getPictureHandler extends Handler{
        ...
        public void handleMessage(Message msg) {
            ...
            if (isRunning) {
                ...
                Log.d("translation x y", values[2] + " " + values[5]);

                Matrix afterMatrix = new Matrix();
                afterMatrix.postTranslate(values[2], values[5]);
